...
La produzione dei documenti diversi dai verbali è organizzata in modo da evitare il conflitto di interessi. La stesura e la verifica del documento in una stessa versione sono svolte da persone distinte per evitare un conflitto di interessi.
...
\begin{figure}[H]
	...
	\caption{ Istogramma della suddivisione delle ore durante il periodo di Analisi}
	\label{fig:IstogrammaFase1}
\end{figure}
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{  Areogramma della ripartizione di ore per ruolo nel periodo di Analisi}
	\label{fig:AreogrammaFase1}
\end{figure}	
...
\begin{figure}[H]
	...
	\caption{ Istogramma della suddivisione delle ore durante il periodo di Progettazione architetturale}
	\label{fig:IstogrammaFase2}
\end{figure}
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{ Areogramma della ripartizione di ore per ruolo nel periodo di Progettazione architetturale}
	\label{fig:AreogrammaFase2}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{ Istogramma della suddivisione delle ore durante il periodo di Progettazione di dettaglio e codifica}
	\label{fig:IstogrammaFase3}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{ Istogramma della suddivisione delle ore durante il periodo di Validazione e collaudo}
	\label{fig:IstogrammaFase4}
\end{figure}
...
\textbf{Totale} & 102 & 142 & 141 & 106 & 183 & 285 & 959 \\ \hline
	\end{tabular}
	\caption{ Prospetto orario che comprende tutti periodi trattati in precedenza\\}
\end{table}	
I dati ottenuti possono essere riassunti nel seguente istogramma:
...
\begin{figure}[H]
	...
	\caption{ Istogramma della suddivisione delle ore di tutti i periodi trattati in precedenza}
	\label{fig:IstogrammaTotale}
\end{figure}
...
\textbf{Totale} & 959 & 19741\euro \\ \hline
	\end{tabular}
	\caption{ Prospetto dei costi totali per ciascun ruolo \\}
\end{table}
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{ Areogramma dei costi totali delle ore di investimento e rendicontate}
    \label{fig:AreogrammaTotale}
\end{figure}
...
\textbf{Totale} & 68 & 78 & 62 & 106 & 183 & 203 & 700 \\ \hline
	\end{tabular}
	\caption{ Prospetto orario che comprende tutte le ore rendicontate\\}
\end{table}	
I dati ottenuti possono essere riassunti nel seguente istogramma:
...
\begin{figure}[H]
	...
	\label{fig:IstogrammaTotaleRendicontato}
\end{figure}
...
\textbf{Totale} & 700 & 14026\euro \\ \hline
	\end{tabular}
	\caption{ Prospetto dei costi totali rendicontati \\}
\end{table}
...
\begin{figure}[H]
    ...
    \label{fig:AreogrammaTotaleRendicontato}
\end{figure}
