...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption*{\textbf{Figura 9}: Areogramma della ripartizione di ore per ruolo nella fase di Progettazione architetturale}
	\label{fig:Figura10}
\end{figure}
...
Nella seguente tabella viene riportata la distribuzione oraria di tutte le fasi a carico del committente, ad esclusione quindi, dell'Analisi dei requisiti:
