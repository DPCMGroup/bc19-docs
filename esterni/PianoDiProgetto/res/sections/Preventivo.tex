...
\end{tabular}
\caption*{\textbf{Tabella 1}: Distribuzione delle ore nel periodo di Analisi\\}
\end{table}	
...
\end{tabular}
	\caption*{\textbf{Tabella 2}: Prospetto dei costi per ruolo nel periodo di Analisi\\}
\end{table}
...
\textbf{Totale} & 102 & 142 & 141 & 106 & 183 & 285 & 959 \\ \hline
	\end{tabular}
	\caption*{\textbf{Tabella 9}: Prospetto orario che comprende tutti periodi trattati in precedenza\\}
\end{table}	
I dati ottenuti possono essere riassunti nel seguente istogramma:
