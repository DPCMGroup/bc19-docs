...
\begin{figure}[H]
	...
	\caption*{\textbf{Figura 3}: Istogramma della suddivisione delle ore durante il periodo di Analisi}
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption*{\textbf{Figura 4}:  Areogramma della ripartizione di ore per ruolo nel periodo di Analisi}
...
\begin{figure}[H]
	...
	\caption*{\textbf{Figura 5}: Istogramma della suddivisione delle ore durante il periodo di Progettazione architetturale}
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption*{\textbf{Figura 6}: Areogramma della ripartizione di ore per ruolo nel periodo di Progettazione architetturale}
...
\begin{figure}[H]
	...
	\caption*{\textbf{Figura 7}: Istogramma della suddivisione delle ore durante il periodo di Progettazione di dettaglio e codifica}
...
\begin{figure}[H]
	...
	\caption*{\textbf{Figura 11}: Istogramma della suddivisione delle ore di tutti i periodi trattati in precedenza}
