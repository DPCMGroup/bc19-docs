...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{10mm}|p{10mm}|p{10mm}|p{10mm}|p{10mm}|p{10mm}|}
		...
		\hline
	\end{tabular}
	\caption*{\textbf{Tabella 2}: Pianificazione riguardante il 1° microperiodo\\}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{10mm}|p{10mm}|p{10mm}|p{10mm}|p{10mm}|p{10mm}|}
		...
		\hline
	\end{tabular}
	\caption*{\textbf{Tabella 5}: Pianificazione riguardante il 4° microperiodo\\}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{10mm}|p{10mm}|p{10mm}|p{10mm}|p{10mm}|p{10mm}|}
		...
		\hline
	\end{tabular}
	\caption*{\textbf{Tabella 6}: Pianificazione riguardante il 5° microperiodo\\}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{8mm}|p{8mm}|p{8mm}|p{8mm}|p{8mm}|p{8mm}|}
		...
		\hline
	\end{tabular}
	\caption*{\textbf{Tabella 7}: Pianificazione riguardante il periodo di Progettazione di dettaglio e codifica\\}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{10mm}|p{10mm}|p{10mm}|p{10mm}|p{10mm}|p{10mm}|}
		...
		Codifica funzionalità secondarie                                            & 1           &             &             &             & 26          & 7           \\ \hline
