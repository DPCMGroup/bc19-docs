...
\begin{landscape}
	\begin{figure}[H]
		...
		\caption*{\textbf{Figura 3}{: Grafico di Gantt del periodo di Progettazione architetturale}}
		\label{fig:Gantt Analisi dei requisiti}
	\end{figure}
\end{landscape}
...
\begin{landscape}
	\begin{figure}[H]
		...
		\caption*{\textbf{Figura 4}{: Grafico di Gantt del periodo di Validazione e collaudo}}
		\label{fig:Gantt Analisi dei requisiti}
	\end{figure}
\end{landscape}
