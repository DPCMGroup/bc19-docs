...
\subsubsection{GuideActivity}

\subsubsection{SearchWorkstationActivity}

\subsubsection{BookingActivity}
\begin{figure}[H]
	\centering
...
\end{figure}
La classe BookingActivity rappresenta la pagina dedicata alle prenotazioni effettuate da un utente. L'utente per visualizzare le prenotazioni deve premere sul menu a tendina del menù principale e successivamente deve premere sulla voce "Visualizza Prenotazioni" e verrà reindirizzato alla pagina dedicata.
