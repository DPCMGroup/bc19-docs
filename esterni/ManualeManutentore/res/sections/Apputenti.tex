...
\begin{itemize}
	...
	\item \textbf{getUser(): User?}: Si occupa di richiedere allo User le informazioni. 
	\item \textbf{setLoginListener(listener:LoginListener?): void}: Si occupa di settare il listner per richiamare il Presenter. 
	\item \textbf{loginHandle(response:String): void}: Si occupa di gestire la risposta fornita dal service. 
\end{itemize}
