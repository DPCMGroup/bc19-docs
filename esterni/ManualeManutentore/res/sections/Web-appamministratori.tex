...
Classe fornita dalla libreria Rxjs. Viene utilizzata per effettuare chiamate \glock{asincrone} al server. Per una documentazione più approfondita fare riferimento a \url{https://angular.io/guide/rx-library}. \newline
Questa classe presenta i seguenti metodi:
\begin{itemize}
