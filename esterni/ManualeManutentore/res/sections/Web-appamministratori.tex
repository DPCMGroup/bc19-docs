...
Il modello a componenti offerto da Angular, descritto nella precedente sottosezione, facilita l'estendibilità dell'applicazione. Per introdurra una nuova funzionalità per l'utente sarà infatti sufficiente creare un componente apposito tramite il comando \newline
