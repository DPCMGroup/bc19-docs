...
\begin{itemize}
	\item \textbf{+ constructor(private loginService: LoginService, private localAccountService: LocalAccountService)}
...
\begin{itemize}
	...
	\item \textbf{+ mail: string}
	\item \textbf{+ type: number}
	\item \textbf{+ archived: number}
\end{itemize}
...
Questa classe presenta i seguenti metodi:
\begin{itemize}
	\item \textbf{+ constructor(private service: SharedService, private cd: ChangeDetectorRef)} 
	\item \textbf{+ ngOnInit(): void} \newline
...
\begin{itemize}
	\item \textbf{+ id: number } 
	\item \textbf{+ tag: string } 
	\item \textbf{+ workstationname: string } 
	\item \textbf{+ xworkstation: string } 
	\item \textbf{+ yworkstation: string } 
	\item \textbf{+ idroom: number } 
	\item \textbf{+ state: bool } 
	\item \textbf{+ sanitized: bool } 
	\item \textbf{+ archived: bool } 
...
Questa classe presenta i seguenti metodi:
\begin{itemize}
	\item \textbf{+ constructor(service: WorkstationsService) }
...
\begin{itemize}
	\item \textbf{+ id: number 	}
	\item \textbf{+ roomname: string 	}
	\item \textbf{+ xroom: string 	}
	\item \textbf{+ yroom: string 	}
	\item \textbf{+ archived: number 	}
	\item \textbf{+ noticeChangeVariable: boolean 	}
...
Questa classe presenta i seguenti metodi:
\begin{itemize}
	\item \textbf{+ constructor(http: HttpClient) 	}
...
\begin{itemize}
	...
	\item \textbf{+ tag: string 	}
	\item \textbf{+ workstationname: string 	}
	\item \textbf{+ xworkstation: number 	}
	\item \textbf{+ yworkstation: number 	}
	\item \textbf{+ idroom: number 	}
	\item \textbf{+ state: number 	}
	\item \textbf{+ sanitized: number 	}
	\item \textbf{+ archived: number}
\end{itemize}
...
\begin{itemize}
	\item \textbf{+ id: number 	}
	\item \textbf{+ roomname: string 	}
	\item \textbf{+ xroom: number 	}
	\item \textbf{+ yroom: number 	}
	\item \textbf{+ archived: number}
\end{itemize}
\subparagraph{Observable<T>}
Classe fornita dalla libreria Rxjs. Viene utilizzata per effettuare chiamate asincrone al server. Per una documentazione più approfondita fare riferimento a \url{https://angular.io/guide/rx-library}. \newline
