...
\end{figure}
Il modello imposta dal Angular prevede che ogni funzionalità disponibile all'utente sia costituita da una vista (view) e da una logica (viewmodel) e chiama l'insieme di queste due parti "componente".
