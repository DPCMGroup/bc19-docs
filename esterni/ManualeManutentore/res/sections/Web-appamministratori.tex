...
Le funzionalità che vi sono contenute sono ulteriormente suddivise in due package:
\begin{itemize}
	\item credentials
	\item rooms
\end{itemize}
Il primo contiene i componenti per la gestione delle credenziali, mentre il secondo contiene quelli per la gestione delle credenziali.la gestione delle credenziali, a sua volta racchiusa nel package Credentials, e la gestione delle stanze e delle postazioni, racchiusa nel package Rooms. La classe BaseComponent gestisce la visualizzazione del component  La classe BaseComponent viene utilizzata per gestire la visualizzazione dell'una o dell'altra funzionalità, e permette inoltre l'azione di logout.
