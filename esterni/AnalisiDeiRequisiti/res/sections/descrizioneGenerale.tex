...
\end{itemize}
Dopo la registrazione dell’applicazione un amministratore del sistema può creare le utenze ai dipendenti e agli addetti delle pulizie. Egli definisce le postazioni e le stanze, inserisce i tag RFID e li associa alle rispettive postazioni.
...
Ad un amministratore, per usufruire del servizio, è sufficiente un browser installato su un computer con connessione a internet; per gli utenti dell'applicazione un dispositivo con SO Android, una connessione a internet e un tag RFID (in particolare NFC) o in modo opzionale della tecnologia bluetooth low energy.
