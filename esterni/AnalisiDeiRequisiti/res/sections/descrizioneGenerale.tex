...
\end{itemize}
Dopo la registrazione dell’applicazione un amministratore del sistema può creare le utenze ai dipendenti e agli addetti delle pulizie. Egli definisce le postazioni e le stanze, inserisce i \glock{tag RFID} e li associa alle rispettive postazioni.
