...
\begin{figure}[H]
	\centering
	\includegraphics[width=18cm]{res/images/UC16.2.png}
...
\begin{itemize}
	...
	amministratore.
	\item\textbf{Descrizione:} 
	l'utente inserisce la prima dimensione della stanza.
	\item\textbf{Scenario principale:} 
	l'utente inserisce la prima dimensione della stanza.
	\item\textbf{Precondizione:} 
	l'utente non ha ancora inserito la prima dimensione della stanza.
	\item\textbf{Postcondizione:}
	l'utente ha inserito la prima dimensione della stanza.
\end{itemize}
...
\begin{itemize}
	...
	amministratore.
	\item\textbf{Descrizione:} 
	l'utente inserisce la seconda dimensione della stanza.
	\item\textbf{Scenario principale:} 
	l'utente inserisce la seconda dimensione della stanza.
	\item\textbf{Precondizione:} 
	l'utente non ha ancora inserito la seconda dimensione della stanza.
	\item\textbf{Postcondizione:}
	l'utente ha inserito la seconda dimensione della stanza.
\end{itemize}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item inserisce i nuovi dati. Solo se la postazione non è occupata è possibile modificarne la posizione (UC26.3) e impostarla come guasta (UC26.4);
...
\subsubsection{ UC26.4 - Impostazione stato guasta/libera}
\begin{itemize}
	\item\textbf{Attori Primari:}
	amministratore.
	\item\textbf{Descrizione:}
...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\subsubsection{ UC58 - Selezione postazione libera e igienizzata con maggiore distanza dalle altre}
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
