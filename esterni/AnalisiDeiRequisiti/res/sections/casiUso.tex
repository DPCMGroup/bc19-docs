...
\subsubsection{ UC8 - Visualizzazione stato postazione}
\begin{figure}[H]
	\centering
...
\begin{itemize}
           	...
           	\item\textbf{Estensioni:}
           	\begin{itemize}
           		\item[$-$] visualizzazione errore: lo smartphone è troppo distante dal tag RFID per effettuare correttamente la scansione (UC9.2).
           	\end{itemize}
\end{itemize}
...
\end{itemize}
\subsubsection{ UC8.2 - Visualizzazione errore scansione: tag RFID troppo distante}
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\subsubsection{ UC9 - Segnalazione presenza}
\begin{figure}[H]
	\centering
...
\begin{itemize}
           	...
           	\begin{itemize}
           		...
           		dopo un timeout di qualche minuto(ad esempio 10 minuti), viene visualizzato un messaggio di errore (UC10.2);
           		\item[$-$] visualizzazione errore: se l'utente si dimentica di premere il bottone della fine dell'occupazione della postazione, viene visualizzato un messaggio di errore (UC 10.4).
           	\end{itemize}
\end{itemize}
\subsubsection{ UC9.1 - Presenza in tempo reale}
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
	\item\textbf{Attori Secondari:} tag RFID.
	\item\textbf{Descrizione:} l’utente segnala in tempo reale la presenza alla postazione, appoggiando il cellulare sul tag RFID.
...
\end{itemize}
\subsubsection{ UC9.4 - Visualizzazione errore fine occupazione}
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\end{itemize}
\subsubsection{ UC10.1 - Modifica stato postazione }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\end{itemize}
\subsubsection{ UC11.1 - Cerca postazione}
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
	\item\textbf{Descrizione:} l’utente vuole prenotare una postazione di una stanza in un determinato giorno e orario.
	\item\textbf{Scenario principale:} 
	\begin{itemize}
		\item[$-$] l’utente inserisce la data (UC10.1.1);
		\item[$-$] l’utente inserisce l'orario (UC10.1.3);
		\item[$-$] l’utente inserisce l'identificativo della stanza (UC10.1.5).
	\end{itemize}
	...
	\begin{itemize}
		\item[$-$] l’utente inserisce una data non valida (UC10.1.2);
		\item[$-$] l’utente inserisce un orario non valida (UC10.1.4);
		\item[$-$] l’utente inserisce una stanza non valida (UC10.1.6).
	\end{itemize}
\end{itemize}
...
\end{itemize}
\subsubsection{ UC11.1.2 - Visualizzazione errore: data non valida  }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\begin{itemize}
	...
	\item\textbf{Postcondizione:} l’utente ha compilato il campo richiesto.
\end{itemize}
\subsubsection{ UC11.1.4 - Visualizzazione errore: orario non valido }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\begin{itemize}
	...
	\item\textbf{Postcondizione:} l’utente ha compilato il campo richiesto.
\end{itemize}
\subsubsection{ UC11.1.6 - Visualizzazione errore: stanza non valida }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\subsubsection{ UC11.3 - Visualizzazione errore: stanze occupate }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
	...
	\item\textbf{Postcondizione:} l’utente visualizza un messaggio di errore specifico e non porta a termine l’azione.
\end{itemize}
\subsubsection{ UC11.4 - Prima postazione libera }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
	...
	\item\textbf{Scenario principale:} viene fornito l'identificativo di una postazione libera e igienizzata, oppure di una libera e non igienizzata (si veda UC11).
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] tutte le postazioni nella stanza selezionata sono occupate o guaste (UC12.3).
	\end{itemize}
\end{itemize}
\subsubsection{ UC11.5 - Selezione postazione }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\begin{itemize}
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] nel caso in cui si scelga di prenotare una postazione libera e sporca si veda il caso d'uso "Pulizia autonoma"(UC11),
		per poi tornare allo scenario principale.
	\end{itemize}
\end{itemize}
\subsubsection{ UC12 - Elenco stanze e postazioni da igienizzare}
\begin{figure}[H]
		\centering
...
\end{itemize}
\subsubsection{UC12.2 - Elenco postazioni da igienizzare}
\begin{itemize}
           	\item\textbf{Attori Primari:} addetto pulizie.
...
\begin{itemize}
		...
		\item\textbf{Attori Secondario:} Ethereum.
           	...
           	\item\textbf{Scenario principale:} l'utente igienizza la stanza(UC13.1) o la postazione(UC13.2), in seguito accede al sistema e la marca come igienizzata attraverso l'utilizzo di Ethereum.
...
\end{itemize}
\subsubsection{UC13.1 - Marcatura stanza come igienizzata}
\begin{itemize}
           	\item\textbf{Attori Primari:} addetto pulizie.
		\item\textbf{Attori Secondario:} Ethereum.
