...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item[$-$] visualizzazione errore: se l'utente si dimentica di premere il bottone di fine occupazione della postazione, viene visualizzato un messaggio di errore (UC21.4).
	\end{itemize}
\end{itemize}
