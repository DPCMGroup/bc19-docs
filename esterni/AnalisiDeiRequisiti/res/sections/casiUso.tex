...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item l'amministratore visualizza le stanze e lo stato delle postazioni. I possibili stati delle postazioni sono:
		\begin{itemize}
	...
	\item\textbf{Postcondizione:}
	L'amministratore visualizza l'elenco delle stanze. Ogni stanza è rappresentata tramite uno scacchiera. Ogni casella della scacchiera può indicare una postazione con il suo rispettivo stato.
\end{itemize}
...
\begin{itemize}
	...
	\item\textbf{Scenario principale:}
	\begin{enumerate}
		\item l'ammistratore inserisce il nickname oppure il nome e cognome dell'utente a cui è interessato e periodo all'interno del quale cercare, indicando date di inizio e di fine;
		\item l'utente può opzionalmente specificare una postazione indicandone il codice;
...
\subsubsection{ UC20.4 - Report vicini di postazione}
\begin{itemize}
	\item\textbf{Attori Primari:} 
	amministratore.
	\item\textbf{Descrizione:} 
...
\subsubsection{ UC24.2.1 - Visualizzazione messaggio promemoria di inizio occupazione}
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
	...
	\item\textbf{Postcondizione:} viene visualizzato un messaggio promemoria di inizio occupazione della postazione.
\end{itemize}

\subsubsection{ UC24.2.2 - Visualizzazione messaggio promemoria di fine occupazione}
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
	...
	\item\textbf{Postcondizione:} viene visualizzato un messaggio promemoria di fine occupazione della postazione.
\end{itemize}
...
\begin{itemize}
	...
	\item\textbf{Scenario Principale:} l'utente non ha ancora appoggiato il telefono sul tag NFC dopo trenta minuti l'inizio della prenotazione:
	\begin{enumerate}
