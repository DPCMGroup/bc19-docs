...
\begin{itemize}
	\item\textbf{Attori Primari:} utente non autenticato.
	\item\textbf{Descrizione:} l’utente tenta di autenticarsi all'applicativo, inserendo il nome utente.
	\item\textbf{Scenario principale:} l’utente non è ancora autenticato ed inserisce il suo nome utente.
	\item\textbf{Precondizione:} l’utente non si è autenticato nell'applicativo. 
	\item\textbf{Postcondizione:} l’utente ha inserito il suo nome utente nella form di login.
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] Visualizzazione messaggio di errore (UC6);
		\item[$-$] Visualizzazione schermata relativa a utente non abilitato (UC7).
