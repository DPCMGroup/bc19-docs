...
\subsubsection{ UC6 - Esplorazione postazioni occupate da uno specifico utente}
\begin{figure}[H]
	\centering
...
\begin{itemize}
           	...
           	\item\textbf{Estensioni:}
           	ricerca tra le postazioni occupate da uno specifico utente (UC6.2).
           	\item\textbf{Precondizione:} 
           	l'utente è autenticato come amministratore.
           	\item\textbf{Postcondizione:}
           	l'utente visualizza le informazioni.
...
\subsubsection{ UC6.2 - Ricerca tra le postazioni occupate da uno specifico utente}
\begin{itemize}
	\item\textbf{Attori Primari:} 
	amministratore
	\item\textbf{Descrizione:} 
