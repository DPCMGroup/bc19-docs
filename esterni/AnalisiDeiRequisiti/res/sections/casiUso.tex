...
\begin{itemize}
		...
		\item\textbf{Attori Secondario:} Ethereum.
           	...
           	\item\textbf{Scenario principale:} l'utente igienizza la stanza(UC14.1) o la postazione(UC14.2), in seguito accede al sistema e la marca come igienizzata attraverso l'utilizzo di Ethereum.
