...
\subsubsection{ UC8 - Scansione tag RFID}
\begin{itemize}
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] visualizzazione errore: lo smartphone è troppo distante dal tag RFID per effettuare correttamente la scansione (UC8.1).
	\end{itemize}
\end{itemize}
\subsubsection{ UC8.1 - Visualizzazione errore scansione: tag RFID troppo distante}
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item[$-$] visualizzazione errore: se l'utente si dimentica di premere il bottone di fine occupazione della postazione, viene visualizzato un messaggio di errore (UC10.4).
	\end{itemize}
\end{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=18cm]{res/images/UC12Dipendente.png}
...
\begin{itemize}
	...
	\item\textbf{Scenario principale:} 
	\begin{itemize}
		\item[$-$] l’utente inserisce la data (UC12.1.1);
		\item[$-$] l’utente inserisce l'orario (UC12.1.3);
		\item[$-$] l’utente inserisce l'identificativo della stanza (UC12.1.5).
	\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item[$-$] l’utente inserisce una data non valida (UC12.1.2);
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item\textbf{Estensioni:} l’utente inserisce i campi necessari alla ricerca della postazione desiderata.
	\begin{itemize}
		\item[$-$] l’utente inserisce un orario non valido (UC12.1.4);
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item\textbf{Estensioni:} l’utente inserisce i campi necessari alla ricerca della postazione desiderata.
	\begin{itemize}
		\item[$-$] l’utente inserisce una stanza non valida (UC12.1.6).
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] visualizzazione errore: tutte le postazioni nella stanza selezionata sono occupate o guaste (UC12.3).
	\end{itemize}
\end{itemize}
\subsubsection{ UC12.3 - Visualizzazione errore: postazioni occupate }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
	...
	\item\textbf{Postcondizione:} l’utente visualizza un messaggio di errore specifico e non porta a termine l’azione.
\end{itemize}
\subsubsection{ UC12.4 - Prima postazione libera }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		per poi tornare allo scenario principale (12.7).
	\end{itemize}
\end{itemize}
