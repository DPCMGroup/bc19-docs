...
\begin{figure}[H]
	...
	\caption{Report igienizzazioni postazione}
	\label{fig:Report igienizzazioni postazione}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=18cm]{res/images/UC24.1.png}
	\caption{Scaricamento del report delle igienizzazioni in un formato leggibile}
	\label{fig:Scaricamento del report delle igienizzazioni in un formato leggibile}
\end{figure}
\begin{itemize}
           	\item\textbf{Attori Primari:} 
           	amministratore.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{res/images/UC27.png}
	\caption{Segnalazione occupazione}
	\label{fig:Segnalazione occupazione}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=18cm]{res/images/UC27.2.png}
	\caption{Registrazione occupazione}
	\label{fig:Registrazione occupazione}
\end{figure}
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
