...
\begin{itemize}
           	...
           	\item\textbf{Estensioni:}
           	\begin{itemize}
           		\item[$-$] visualizzazione errore: lo smartphone è troppo distante dal tag RFID per effettuare correttamente la scansione (UC8.2).
           	\end{itemize}
\end{itemize}
...
\begin{itemize}
           	...
           	\begin{itemize}
           		...
           		dopo un timeout di qualche minuto, viene visualizzato un messaggio di errore (UC9.2);
           		\item[$-$] visualizzazione errore: se l'utente si dimentica di premere il bottone di fine occupazione della postazione, viene visualizzato un messaggio di errore (UC 9.4).
           	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item\textbf{Scenario principale:} 
	\begin{itemize}
		\item[$-$] l’utente inserisce la data (UC11.1.1);
		\item[$-$] l’utente inserisce l'orario (UC11.1.3);
		\item[$-$] l’utente inserisce l'identificativo della stanza (UC11.1.5).
	\end{itemize}
	...
	\begin{itemize}
		\item[$-$] l’utente inserisce una data non valida (UC11.1.2);
		\item[$-$] l’utente inserisce un orario non valido (UC11.1.4);
		\item[$-$] l’utente inserisce una stanza non valida (UC11.1.6).
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] visualizzazione errore: tutte le postazioni nella stanza selezionata sono occupate o guaste (UC11.3).
	\end{itemize}
\end{itemize}
\subsubsection{ UC11.3 - Visualizzazione errore: postazioni occupate }
\begin{itemize}
	\item\textbf{Attori Primari:} dipendente.
...
\begin{itemize}
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] tutte le postazioni nella stanza selezionata sono occupate o guaste (UC11.3).
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] nel caso in cui l'utente scelga di prenotare una postazione libera e sporca si veda UC10,
