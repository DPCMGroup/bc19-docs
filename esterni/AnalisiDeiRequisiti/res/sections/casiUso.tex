...
\begin{itemize}
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] UC13.1 - Avviso codice postazione già utilizzato;
		\item[$-$] UC13.2 - Avviso codice tag già utilizzato.
	\end{itemize}
	\item\textbf{Precondizione:} 
	l'utente è autenticato.
	\item\textbf{Postcondizione:}
...
\subsubsection{ 18 - Esplorazione occupazioni delle postazioni}
\begin{figure}[H]
	\centering
...
\begin{itemize}
           	...
           	\begin{itemize}
           		...
           		\item[$-$] ricerca tra le postazioni occupate da uno specifico utente (UC18.1.1).
           	\end{itemize}
           	\item\textbf{Precondizione:} 
           	l'utente è autenticato come amministratore.
           	\item\textbf{Postcondizione:}
...
\begin{itemize}
	...
	\begin{itemize}
		\item[$-$] scaricamento del report delle occupazioni in un formato leggibile (UC18.3);
		\item[$-$] ricerca tra le occupazioni di una specifica postazione (UC18.2.1).
	\end{itemize}
	\item\textbf{Precondizione:} 
	l'utente è autenticato come amministratore.
	\item\textbf{Postcondizione:}
...
\begin{itemize}
	...
	\item\textbf{Estensione:}
	\begin{itemize}
		\item[$-$] scaricamento del report delle occupazioni in formato PDF (UC18.3.1).
	\end{itemize}
	\item\textbf{Precondizione:} 
...
\begin{itemize}
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] scaricamento del report delle igienizzazioni in formato PDF (UC19.1.1).
	\end{itemize}
	\item\textbf{Precondizione:} 
	l'utente sta visualizzando un report.
	\item\textbf{Postcondizione:}
...
\begin{itemize}
	...
	\item\textbf{Estensioni:}
	\begin{itemize}
		\item[$-$] nel caso in cui l'utente scelga di prenotare una postazione libera e sporca si veda UC24, per poi tornare allo scenario principale di questo caso d'uso.
	\end{itemize}
\end{itemize}
