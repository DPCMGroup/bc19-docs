...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item l'amministratore visualizza il report richiesto.
	\end{enumerate}
	\item\textbf{Precondizione:} 
...
\subsubsection{ UC35 - Ottenimento report certificato delle occupazioni e delle igienizzazioni}
\begin{itemize}
	\item\textbf{Attori Primari:} 
	amministratore.
	\item\textbf{Descrizione:} 
	...
	\begin{enumerate}
		...
		\item viene generato un report che presenta per ogni giorno la situazione delle occupazioni e delle igienizzazioni con i rispettivi hash generati in quella data: hash del report e hash della transazione nella blockchain.  
	\end{enumerate}
	\item\textbf{Generalizzazione:}
	\begin{itemize}
		\item[$-$] Ottenimento report (UC32).
