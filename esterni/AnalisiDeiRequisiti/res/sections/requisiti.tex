...
\begin{center}
	...
	\begin{longtable}{|c|p{10cm}|p{4cm}|}
		...
		\hline
		R1F16.2.1&L'amministratore deve poter specificare la dimensione x della nuova stanza.	& Capitolato - UC16.2.1	\\
		\hline
		R1F16.2.2&L'amministratore deve poter specificare la dimensione y della nuova stanza.	& Capitolato - UC16.2.2	\\
		\hline
		...
		\hline
		R1F21.3&L'amministratore deve poter specificare la posizione, definita dalle coordinate x e y, della nuova postazione all'interno della stanza. & Capitolato - UC21.3 \\
		\hline
		R1F21.3.1&L'amministratore deve poter specificare la coordinata x della posizione della nuova postazione all'interno della stanza. & Capitolato - UC21.3.1 \\
		\hline
		R1F21.3.2&L'amministratore deve poter specificare la coordinata y della posizione della nuova postazione all'interno della stanza. & Capitolato - UC21.3.2 \\
		\hline
		...
		\hline
		R1F24&Se si tenta di creare o modificare una postazione assegnandole una posizione già in utilizzo, oppure che supera le dimensioni della stanza, l'azione deve fallire e deve comparire un messaggio d'errore.	&VE\_2020\_12\_18v.1.0.0 - UC24 	\\
		\hline
		...
		\hline
		R1F26.3& L'amministratore deve poter modificare la posizione, definita dalle coordinate x e y, della postazione.  & Capitolato - UC26.3	\\
		\hline
		R1F26.3.1& L'amministratore deve poter modificare la coordinata x della posizione della postazione. & Capitolato - UC26.3	\\
		\hline
		R1F26.3.2& L'amministratore deve poter modificare la coordinata y della posizione della postazione. & Capitolato - UC26.3	\\
		\hline
		...
		\hline
		R1F42.1&Il dipendente deve poter registrare il momento di inizio della sua occupazione di una postazione.&Capitolato - UC42.1 	\\
		\hline
		R1F42.2&Il dipendente deve poter segnalare la propria presenza su una postazione in tempo reale, tramite tag NFC.&Interna - UC42.2 	\\
		\hline
		R1F43&Se l'utente sposta il proprio smartphone dal tag NFC per un periodo di tempo maggiore o uguale a trenta minuti avviene la disdetta automatica della prenotazione per il tempo restante e viene registrata la fine dell'occupazione.	&Interna - UC43 	\\
		\hline
