...
\begin{center}
	...
	\begin{longtable}{|c|p{10cm}|p{4cm}|}
		...
		\hline
		R1F19 & Il dipendente deve poter effettuare una scansione del tag NFC presente su una postazione & Capitolato - UC19 \\
		\hline
		R1F19.1 & Se il dipendente tenta di effettuare una scansione del tag NFC ma il telefono si trova ad una distanza troppo elevata dal tag, viene visualizzato un errore & Interna - UC19.1 \\
		\hline
		R1F20&Il dipendente deve poter visualizzare lo stato di una postazione, tramite tag NFC.	&Capitolato - UC20 	\\
		\hline
		R1F21&Il dipendente deve poter segnalare la propria presenza su una postazione in tempo reale, tramite tag NFC.	&Capitolato - UC21 	\\
		\hline
