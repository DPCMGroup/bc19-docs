...
\begin{center}
	...
	\begin{longtable}{|c|p{10cm}|p{4cm}|}
		...
		\hline
		R1F26&L'amministratore deve poter modificare:
		\begin{itemize}
			\item codice della postazione;
			\item codice del tag NFC che la identifica.
		\end{itemize}
