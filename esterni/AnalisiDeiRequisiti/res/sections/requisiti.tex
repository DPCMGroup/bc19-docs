...
\begin{center}
	...
	\begin{longtable}{|c|p{10cm}|p{4cm}|}
		...
		R1F16&L'amministratore deve poter gestire le credenziali degli utenti	& Capitolato - UC16		\\
		\hline
		R1F16.1&L'amministratore deve poter visualizzare una lista delle credenziali di tutti gli utente del sistema	& Capitolato - UC16.1	\\
		\hline
		R1F16.2&L'amministratore deve poter creare nuove credenziali per accedere al sistema. Le informazioni contenute nel profilo di un utente sono: Nome, Cognome, Nome utente, Password e Email. Tra queste le informazioni necessarie per l'accesso sono password e nome utente	& Capitolato - VE\_2021\_01\_01v.1.0.0 - UC16.2	\\
		\hline
		R1F16.3&L'amministratore può modificare le credenziali degli utenti del sistema	&Capitolato - UC16.3 	\\
		\hline
		R1F16.4&L'amministratore deve poter eliminare credenziali degli utenti del sistema	& Capitolato - UC16.4	\\
		\hline
		R1F16.5&Il sistema deve poter memorizzare più credenziali per ogni categoria di utenti: amministratori, dipendenti e addetti	& Capitolato - VE\_2021\_01\_01v.1.0.0	\\
		\hline
		R1F17&L'amministratore deve poter esplorare la storia delle occupazioni delle postazioni	& Capitolato - UC17 - VE\_2021\_01\_04v.1.0.0	\\
		\hline
		R1F17.1&L'amministratore deve poter visualizzare in forma tabellare le occupazioni di postazioni da parte di un utente specifico, con date e orari di inizio e fine delle occupazioni e codici delle postazioni.	&Capitolato - UC17.1 - VE\_2021\_01\_04v.1.0.0	\\
		\hline
		R1F17.1.1&L'amministratore deve poter effettuare una ricerca tra le postazioni occupate da un utente, specificando il periodo all'interno del quale l'utente occupava la postazione. & 	Capitolato - UC17.1.1 - VE\_2021\_01\_04v.1.0.0\\
		\hline
		R2F17.1.2&L'amministratore deve poter visualizzare in forma tabellare le occupazioni di postazioni da parte di un utente specifico, con date e orari di inizio e fine delle occupazioni,  codici delle postazioni e ore trascorse alla postazione. & 	Capitolato - UC17.1.2 - VE\_2021\_01\_04v.1.0.0\\
		\hline
		R1F17.2&L'amministratore deve poter visualizzare in forma tabellare le occupazioni di una postazione specifica, con date e orari di inizio e fine delle occupazioni e nomi e cognomi dei dipendenti.	&Capitolato - UC17.2 - VE\_2021\_01\_04v.1.0.0	\\
		\hline
		R1F17.2.1&L'amministratore deve poter effettuare una ricerca tra le occupazioni di una specifica postazione indicando il periodo all'interno del quale l'utente occupava la postazione	& 	Capitolato - UC17.2.1 - VE\_2021\_01\_04v.1.0.0\\
		\hline
		R1F17.3 & L'amministratore deve poter scaricare il report delle occupazioni che sta visualizzando in un formato leggibile & Capitolato - UC17.3 - VE\_2021\_01\_04v.1.0.0\\
		\hline
		R2F17.3.1 & L'amministratore deve poter scaricare il report delle occupazioni che sta visualizzando nel formato PDF & Capitolato - UC17.3.1 - VE\_2021\_01\_04v.1.0.0\\
		\hline
		R2F18&L'amministratore deve poter ottenere una tabella delle sanificazioni di tutte le postazioni, con data e ora in cui sono avvenute, nome e cognome di chi le ha eseguite e il suo ruolo.	&Capitolato - UC18 - VE\_2021\_01\_04v.1.0.0	\\
		\hline
		R2F18.1&L'amministratore deve poter scaricare il report delle sanificazioni che sta visualizzando in un formato leggibile.	&Capitolato - UC18.1 - VE\_2021\_01\_04v.1.0.0	\\
		\hline
		R2F18.1.1&L'amministratore deve poter scaricare il report delle sanificazioni che sta visualizzando nel formato PDF.	&Capitolato - UC18.1.1 - VE\_2021\_01\_04v.1.0.0	\\
		\hline
		R1F19 & Il dipendente deve poter effettuare una scansione del tag RFID presente su una postazione & Capitolato - UC19 \\
		\hline
		R1F19.1 & Se il dipendente tenta di effettuare una scansione del tag RFID ma il telefono si trova ad una distanza troppo elevata dal tag, viene visualizzato un errore & Interna - UC19.1 \\
		\hline
		R1F20&Il dipendente deve poter visualizzare lo stato di una postazione, tramite tag RFID.	&Capitolato - UC20 	\\
		\hline
		R1F21&Il dipendente deve poter segnalare la propria presenza su una postazione in tempo reale, tramite tag RFID.	&Capitolato - UC21 	\\
		\hline
		R1F21.1&Il dipendente deve poter registrare i momenti di inizio e di fine della sua occupazione di una postazione, tramite Ethereum.	&Interna - UC21.3 	\\
		\hline
		R1F22 & Se un dipendente ha effettuato una prenotazione su una postazione e quella postazione diventa non disponibile, egli deve riceverne notifica & Interna - UC22 \\
		R1F23&Il dipendente deve poter effettuare una pulizia autonoma di una postazione, tramite il kit aziendale.	&Capitolato - UC23	\\
		\hline		
		R1F23.1&Il dipendente, dopo aver effettuato una igienizzazione, deve poter marcare la postazione come libera e igienizzata.	&Interna - UC23.1	\\
		\hline	
		R1F23.2&Il dipendente deve poter registrare l'avvenuta igienizzazione autonoma della postazione, tramite Ethereum.	&Capitolato - UC23.2	\\
		\hline	
		R1F24&Il dipendente deve poter ricercare una postazione in base alla data, all'orario e all'identificativo della stanza.	&Interna - UC24.1	\\
		\hline
		R1F24.1&Il dipendente deve poter visualizzare le postazioni di una stanza.	&Capitolato - UC24.2	\\
		\hline
		R1F24.2&Il dipendente deve poter visualizzare l'identificativo della prima postazione igienizzata e libera in una stanza.	&Capitolato - UC24.4	\\
		\hline
		R1F24.3&Il dipendente deve poter selezionare una postazione di una stanza.	&Interna - UC24.5	\\
		\hline
		R1F24.4&Il dipendente deve poter prenotare una postazione selezionata.	&Capitolato - UC24.6	\\
		\hline
		R1F25&Gli utenti che hanno prenotato una postazione devono essere avvisati se la postazione stessa o la stanza in cui si trovano diventa non disponibile	& VE\_2020\_12\_18v.1.0.0	\\
		\hline
		
		R1F26&L'addetto alle pulizie riceve l'elenco delle stanze e delle postazioni che necessitano di igienizzazione	& Interna - UC26	\\
		\hline
		R1F26.1&	L'addetto alle pulizie riceve l'elenco delle stanze che necessitano di igienizzazione& 	Capitolato - UC26.1\\
		\hline
		R1F26.2&L'addetto alle pulizie riceve l'elenco delle postazioni che necessitano di igienizzazione	& Interna - UC26.2	\\
		\hline
		R1F27&L'addetto alle pulizie deve registrare sulla blockchain, con l'utilizzo di Ethereum, quando igienizza una stanza o una postazione	& Interna - UC27	\\
		\hline
		R1F27.1&L'addetto alle pulizie deve poter marcare, nella sezione apposita, una stanza come igienizzata	& Capitolato - UC27.1	\\
		\hline
		R1F27.2&L'addetto alle pulizie deve poter marcare, nella sezione apposita, una postazione come igienizzata	&Interna - UC27.2 	\\
		\hline
		R1F27.3&L'addetto alle pulizie non può pulire postazioni o stanze occupate	& VE\_2021\_01\_01v.1.0.0	\\
		\hline
		R1F28 &Deve essere realizzato e consegnato un Docker file contenente la componente applicativa. & Capitolato\\
		\hline
