...
\begin{center}
	...
	\begin{longtable}{|c|p{10cm}|p{4cm}|}
		...
		\hline
		R1F26&L'amministratore deve poter modificare i dati di un postazione e, se non è occupata, deve poterne modificare la posizione e deve poterla impostare come guasta, indicando un intervallo di giorni, o, se già guasta, deve poterla impostare come libera. Se viene impostata come guasta, le prenotazioni già effettuate su quella postazione in quel periodo devono essere disdette e non deve essere possibile effettuarne di nuove, sempre all'interno del periodo.	& Capitolato - UC26	\\
		\hline
