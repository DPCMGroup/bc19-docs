...
Per la classificazione dei test si fa riferimento alle sezioni Verifica\footnote{Sezione §3.4} e Validazione\footnote{Sezione §3.5} del documento \dext{Norme di progetto v. 2.0.0}.
	...
	\begin{center}
		...
		\begin{longtable}{|c|p{10cm}|c|}
			...
			\hline
			TU & Si verifichi che vengano settati i campi di ReportData correttamente. & S \\	
			\hline
			TU & Si verifichi che venga creata un'istanza di ReportData. & S \\	
			\hline
			TU & Si verifichi che ShowReportsComponent possa generare report. & S \\	
			\hline
			TU & Si verifichi che venga creata un'istanza di OccupationData. & S \\	
			\hline
			TU & Si verifichi che vengano settati i campi di OccupationData correttamente. & S \\	
			\hline
			TU & Si verifichi che AddEditRoomComponent possa copiare i valori se settata inaccessibile. & S \\	
			\hline
			TU & Si verifichi che AddEditRoomComponent possa copiare i valori se settata inaccessibile. & S \\	
			\hline
			TU & Si verifichi che AddEditRoomComponent possa chiamare copyValues se modificata. & S \\	
			\hline
			TU & Si verifichi che AddEditRoomComponent possa chiamare addRoom. & S \\	
			\hline
			TU & Si verifichi che AddEditRoomComponent possa restituire room dai valori locali. & S \\	
			\hline
			TU & Si verifichi che AddEditRoomComponent possa restituire l'inaccessibilità della stanza. & S \\	
			\hline
			TU & Si verifichi che AddEditRoomComponent copi correttamente i valori se accessibile. & S \\	
			\hline
			TU & Si verifichi che AddEditRoomComponent possa chiamare editRoom. & S \\	
			\hline
			TU & Si verifichi che AddEditRoomComponent non possa ottenere l'inacessibilità della stanza se accessibile. & S \\	
			\hline
			TU & Si verifichi che vengano settati i campi di RoomData correttamente. & S \\	
			\hline
			TU & Si verifichi che vengano settati RoomDataWithDates correttamente. & S \\	
			\hline
			TU & Si verifichi che venga creata un'istanza di RoomData. & S \\	
			\hline
			TU & Si verifichi che AddEditWorkstationComponent possa restituire la workstation dai dati locali. & S \\	
			\hline
			TU & Si verifichi che AddEditWorkstationComponent possa restituire il guasto workstation se la workstation è guasta. & S \\	
			\hline
			TU & Si verifichi che AddEditWorkstationComponent non possa restituire il guasto workstation se la workstation non è guasta. & S \\	
			\hline
			TU & Si verifichi che AddEditWorkstationComponent possa chiamare addWorkstation. & S \\	
			\hline
			TU & Si verifichi che AddEditWorkstationComponent possa chiamare editWorkstation. & S \\	
			\hline
