...
Le caratteristiche sono descritte grazie a dei parametri che valutano il grado di raggiungimento di qualità, in seguito vengono descritti \textbf{solo} gli aspetti che il gruppo 
ha ritenuto importanti per per raggiungere gli obiettivi qualitativi

\subsection{Funzionalità}
Rappresenta la capacità del software di soddisfare tutte le funzionalità che sono state individuate attraverso l'\dext{Analisi dei Requisiti v1.0.0}.
