...
Il risultato sono i processi presentati di seguito.
	...
	\subsection{Processi organizzativi}
		...
		L' obiettivo è quello di avere uno strumento che ci permette di verificare quanto sta migliorando la capacità di \textit{DPCM 2077} nel pianificare correttamente le attività da svolgere.
		...
		\item valore accettabile sovrastima: $2 < ore < 4$.
		\end{itemize}
		...
		\begin{itemize}
		\item valore preferibile sottostima: 0 ore;
		\item valore accettabile sottostima: numero di ore < 5;
		\item valore preferibile sovrastima: $0 < ore < 5$;
		\item valore accettabile sovrastima: 10 ore.
		\end{itemize}
		\end{enumerate}
	...
	\subsection{Tabella riassuntiva}
		...
		\begin{longtable}{|c|c|c|}
			...
			\hline
			AdP: sovrastima per singolo ruolo & $0 < ore < 2$ & $2 < ore < 4$ \\
			\hline
			AdP: sottostima per tutti i ruoli & 0 ore & numero di ore < 5 \\
			\hline
			AdP: sovrastima per tutti i ruoli & $0 < ore < 5$ & 10 ore \\
			\hline
