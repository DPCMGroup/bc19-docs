...
\subsection{Requisiti e installazione}
	Per il corretto funzionamento l'app mobile richiede di essere installata su un dispositivo con sistema operativo \glock{Android} con versione uguale o superiore alla 6.0 Marshmallow.
