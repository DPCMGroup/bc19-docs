...
\item \glock{IAAS Kubernetes} o di un \glock{PaaS} (\glock{Openshift} o \glock{Rancher}) per il rilascio delle componenti del server e la gestione della \glock{scalabilità} orizzontale;
\item \glock{Docker}.
\end{itemize}
