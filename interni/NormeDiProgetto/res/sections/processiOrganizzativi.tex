...
Le email dovranno essere scritte dal Responsabile di Progetto che dovrà avere cura di includere il logo del gruppo e di apporre la propria firma digitale.

\subsection{Riunioni}
Questa sezione ha lo scopo di definire le stesse e le loro modalità di svolgimento. Nelle riunioni è il responsabile che convoca la riunione, stende l'o.d.g, assegnando la giusta priorità ai vari punti da discutere e conduce / modera la discussione. Se qualcuno del gruppo vuole proporre un argomento contatta i responsabili prima della riunione, che lo inseriranno nell'o.d.g e gli daranno la priorità corretta e lo spazio se c'è. Un componente nominato segretario redige solo il verbale.
In Google drive è stato creato un o.d.g. temporaneo dove i componenti possono vedere in anticipo l'o.d.g. della riunione in anticipo.
Si è deciso di creare un documento dove raccogliere le decisioni prese nel corso della settimana per
non perderne traccia. Esse saranno validate alla prima riunione utile.
...
\item{\textbf{tracciamento delle decisioni}: riepilogo in in forma tabella delle decisioni prese nel corso della riunione;}
\end{itemize}
