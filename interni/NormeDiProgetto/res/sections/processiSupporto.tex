			...
			\paragraph{Sviluppo e design}
				...
				\begin{itemize}
						\item \textbf{introduzione:} essa contiene:
							...
							\begin{itemize}
								\item \textbf{codice:} del tipo AAAA-MM-GG_X.Y dove la prima parte indica la data dell'incontro a cui fa riferimento seguita da un numero che indica il numero del verbale(X) ed un secondo numero che indica il punto all'ordine del giorno a cui si riferisce(Y); 								\item \textbf{descrizione:} breve descrizione riassuntiva della decisione presa riguardante il punto dell'ordine del giorno.
							\end{itemize}
					\end{itemize}
